...
export const doctorDetailStyles = {
  ...
  headerTitle: "text-2xl sm:text-1.5xl md:text-5xl font-bold bg-linear-to-r from-emerald-600 to-cyan-600 bg-clip-text text-transparent mt-1 sm:mt-0",
...
export const dashboardStyles = {
  ...
  searchIcon: "absolute right-3 top-2.5 w-5 h-5 text-green-500",
...
export const heroStyles = {
  ...
  mainContainer: "flex items-center pt-9 justify-center px-6 py-6",
