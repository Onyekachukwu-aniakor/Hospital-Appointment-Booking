...
export const bannerStyles = {
  ...
  outerAnimatedBand: "absolute inset-0 rounded-3xl bg-linear-to-r from-green-400 via-emerald-500 to-green-400 animate-[spin_4s_linear_infinite] opacity-80",
...
export const navbarStyles = {
  ...
  doctorAdminText: "hidden lg:text-sm lg:whitespace-nowrap sm:inline-block",
